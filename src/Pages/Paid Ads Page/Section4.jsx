    ...
    <section className="web-dev-secton-4 py-lg-5 py-3">
      <div className="container web-dev-secton-4-content-wrap p-lg-2 p-1 text-center">
        ...
        <div className="c-container-65rem">
          <p className="text-lg-center text-md-center text-justify px-2 px-lg-0 px-md-0 m-0 text-white ff-p c-fw-4 p-text-lg">
            {text}
          </p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="m-auto" style={{ width: "min(100%,69rem)" }}>
