...
function Section4() {
  ...
  const text = `Want to embrace the Digital Frontier? Boost your hospitality business with our cutting-edge Hospitality Marketing Services & Hospitality Digital Marketing Services. Conquer the online realm, attract a broader audience, and experience a surge in bookings. 
    ...
    <section className="web-dev-secton-4 py-lg-5 py-3">
      <div className="container p-lg-2 p-1 text-center">
        ...
        <div className="m-auto" style={{ maxWidth: "85%" }}>
          <p className="text-clr-scorpion p-text-lg ff-p c-fw-4 text-sm-justify text-balance text-md-justify">
            {text}
          </p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="m-auto" style={{ maxWidth: "86%" }}>
